...
import { SubmissionsService } from '@application/SubmissionsService';
...
Container.bind(SubmissionsService).factory(
    () => new SubmissionsService(getConnection().getRepository(FormAnimalSubmission)),
);
