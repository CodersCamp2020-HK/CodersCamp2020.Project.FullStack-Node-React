...
import { PersonalInfoService } from '@application/PersonalInfoService';
...
Container.bind(AnimalsService)
    ...
    .scope(Scope.Local);
Container.bind(PersonalInfoService)
    .factory(() => new PersonalInfoService(getConnection().getRepository(PersonalInfo)))
    .scope(Scope.Local);
